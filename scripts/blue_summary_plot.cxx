...
void blue_summary_plot(TString pdffile="B_CMS_ISR_Run2_Electron_m50to64_5_DisRes_Obs_0.pdf",
                                        TString mass_window="[55, 64]", TString AXIS = "p_{T}^{ee} [GeV]",
                                        TString period1 = "2016a", TString period2 = "2016b", TString period3 = "2018", TString period4 = "2018",
                                        const std::vector<Float_t>& valu  = {14.76, 14.56, 15.25, 14.97, 14.97},
                                        const std::vector<Float_t>& stat  = { 0.06,  0.09,  0.08,  0.07,  0.07},
                                        const std::vector<Float_t>& syst  = { 0.14,  0.14,  0.26,  0.16,  0.16},
                                        const std::vector<Float_t>& full  = { 0.15,  0.17,  0.27,  0.18,  0.18}
                                        ){
	 const Int_t N =  5; 
	 Float_t Indx[N] = { 0, 1, 2, 3, 4};
	 Int_t   Colo[N] = {632, 1, 1, 1, 1};
	 TString Name[N] = {mass_window, period1, period2, period3, period4};
	 Float_t Valu[N];
	 Float_t Stat[N];
	 Float_t Syst[N];
	 Float_t Full[N];
	 ...
	 Text->SetTextColor(kBlack);
	 //Text->DrawLatex(xUnco-0.2,Indx[0]-1.0, UNCB);
